...
# ============================================================
####데이터 가져오기
path = r'C:\상권 예측\train_pk_shift.csv'
...
# 0) 파일 업로드 
# ==========================
path_struct = r"C:\상권 예측\card_ts_q_struct.csv"
...
# ==========================
path_out = r"C:\상권 예측\cohort_q.csv"
...
# 1) 데이터 로드
# =========================
tm_path = r"C:\상권 예측\transition_matrix.csv"
...
# 4) 저장 (2종)
# =========================
out1 = r"C:\상권 예측\transition_heatmap_including_stay.png"
out2 = r"C:\상권 예측\transition_heatmap_transition_only.png"
