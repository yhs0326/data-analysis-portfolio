...
## Featured Problem Solving — Retail CRM Decision Track
...
대표 문제 해결 경험을 우선으로 정리했습니다. **03과 04는 하나의 Retail CRM Decision Track**으로 이어지며, 01과 02는 서로 다른 데이터와 분석 방식에서 문제 정의·검증 역량을 보여주는 Supporting Project입니다.
